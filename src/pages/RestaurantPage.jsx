...
import { Ship, Utensils, Clock, Star, MapPin, Search, ChevronRight, Heart, X, Minus, Plus, ShoppingBag, ArrowLeft } from 'lucide-react';
        ...
        // Vue détaillée du restaurant avec menu complet
          ...
          >
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              <button
                onClick={() => { setPage('restaurant'); setSelectedRestaurant(null); }}
                    ...
                    {filteredRestaurants.map((restaurant) => (
                      ...
                      >
                        <div
                          ...
                          onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setSelectedRestaurant(restaurant); } }}
