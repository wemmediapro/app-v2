...
const ACTIVITIES_TRANSLATIONS = [
  {
    ...
    translations: {
      fr: {
        ...
        description:
          "Partez à l'aventure sur le bateau pour retrouver des indices et découvrir le trésor caché. Une activité ludique qui fait travailler l'observation et l'esprit d'équipe.",
        ageRange: '6-12 ans',
      ...
      en: {
        name: 'Treasure Hunt',
        description:
          'Set off on an adventure across the ship to find clues and discover the hidden treasure. A fun activity that develops observation skills and teamwork.',
        ageRange: '6-12 years',
      ...
      es: {
        ...
        description:
          'Salid de aventura por el barco para encontrar pistas y descubrir el tesoro escondido. Una actividad lúdica que trabaja la observación y el trabajo en equipo.',
        ageRange: '6-12 años',
      ...
      it: {
        ...
        description:
          "Partite per un'avventura sul traghetto per trovare indizi e scoprire il tesoro nascosto. Un'attività ludica che sviluppa l'osservazione e lo spirito di squadra.",
        ageRange: '6-12 anni',
      ...
      de: {
        name: 'Schatzsuche',
        description:
          'Begebt euch auf Abenteuerreise über das Schiff, um Hinweise zu finden und den versteckten Schatz zu entdecken. Ein spielerisches Angebot für Beobachtungsgabe und Teamgeist.',
        ageRange: '6-12 Jahre',
      ...
      ar: {
        name: 'البحث عن الكنز',
        description:
          'انطلق في مغامرة على متن السفينة للعثور على الأدلة واكتشاف الكنز المخفي. نشاط ترفيهي ينمي الملاحظة والعمل الجماعي.',
        ageRange: '6-12 سنة',
  ...
  },
  {
    ...
    translations: {
      fr: {
        ...
        description:
          'Créez une œuvre à partir de coquillages, sable et papiers colorés sur le thème de la mer. Idéal pour développer la créativité et la motricité fine.',
        ageRange: '4-10 ans',
      ...
      en: {
        ...
        description:
          'Create a piece of art using shells, sand and coloured paper on a sea theme. Ideal for developing creativity and fine motor skills.',
        ageRange: '4-10 years',
      ...
      es: {
        ...
        description:
          'Crea una obra con conchas, arena y papeles de colores con tema marino. Ideal para desarrollar la creatividad y la motricidad fina.',
        ageRange: '4-10 años',
      ...
      it: {
        ...
        description:
          "Create un'opera con conchiglie, sabbia e carte colorate a tema mare. Ideale per sviluppare creatività e motricità fine.",
        ageRange: '4-10 anni',
        schedule: 'Mercoledì e sabato 14-15:30',
        features: [
          'Materiale fornito',
          'Tema mare e spiaggia',
          'Attività supervisionata',
          'Porta a casa la tua creazione',
        ],
      },
      de: {
        name: 'Kreativ-Workshop: Meeres-Collage',
        description:
          'Gestaltet ein Kunstwerk aus Muscheln, Sand und buntem Papier zum Thema Meer. Ideal zur Förderung von Kreativität und Feinmotorik.',
        ageRange: '4-10 Jahre',
      ...
      ar: {
        ...
        description:
          'اصنع عملاً فنياً من الأصداف والرمل والأوراق الملونة حول موضوع البحر. مثالي لتنمية الإبداع والمهارات الحركية الدقيقة.',
        ageRange: '4-10 سنوات',
  ...
  try {
    ...
    for (const { nameFr, category, translations } of ACTIVITIES_TRANSLATIONS) {
      ...
      if (!activity) {
        ...
        await EnfantActivity.updateOne({ _id: activity._id }, { $set: { translations } });
