...
**Façades « domaine » (App.jsx)** : `useMoviesLogic`, `useMagazineLogic`, `useRestaurantsLogic`, `useShopLogic` (favoris + promos accueil + catégories), `useEnfantLogic`, `useRadioLogic` → `useRadio`, `useChatLogic` → `useChat`.
